...
import com.android.PasswordManager.ui.password.PasswordViewModel;
...
//        App updater
    ...
    protected void onStart() {
        ...
        if (sharedPreferences.getBoolean("FIRSTNOTICE", true)) {
            ...
            alertDialogBuilder.setMessage("PasswordManager is still in build you may face some issues.");
            //Positive button
